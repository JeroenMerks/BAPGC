...
if version_info >= (2, 6, 0):
    def swig_import_helper():
        ...
        fp = None
        try:
            fp, pathname, description = imp.find_module('_scan',
                                                        [dirname(__file__)])
        except ImportError:
            import _scan
            return _scan
...
class SwigPyIterator(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, SwigPyIterator,
                                                          name, value)
    __swig_getmethods__ = {}
...
class vector_double(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, vector_double,
                                                          name, value)
    __swig_getmethods__ = {}
...
class vector_uchar(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, vector_uchar,
                                                          name, value)
    __swig_getmethods__ = {}
...
class vector_size_t(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, vector_size_t,
                                                          name, value)
    __swig_getmethods__ = {}
...
class vector_vector_double(_object):
    ...
    __setattr__ = lambda self, name, value: _swig_setattr(self,
                                                          ...
                                                          name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, vector_vector_double,
                                                   name)
    __repr__ = _swig_repr
...
class vector_match(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, vector_match,
                                                          name, value)
    __swig_getmethods__ = {}
...
class vector_vector_match(_object):
    ...
    __setattr__ = lambda self, name, value: _swig_setattr(self,
                                                          ...
                                                          name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, vector_vector_match,
                                                   name)
    __repr__ = _swig_repr
...
class vector_string(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, vector_string,
                                                          name, value)
    __swig_getmethods__ = {}
...
class vector_variant(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, vector_variant,
                                                          name, value)
    __swig_getmethods__ = {}
...
class vector_match_variant(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self,
                                                          vector_match_variant,
                                                          name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, vector_match_variant,
                                                   name)
    __repr__ = _swig_repr
...
def scan_best_hits_dna(seq, matrices, target, iterations=10, MULT=3,
                       LIMIT_MULT=10, window_size=7):
    return _scan.scan_best_hits_dna(seq, matrices, target, iterations, MULT,
                                    LIMIT_MULT, window_size)
...
class match(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, match, name,
                                                          value)
    __swig_getmethods__ = {}
...
class variant(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, variant, name,
                                                          value)
    __swig_getmethods__ = {}
    ...
    if _newclass:
        start_pos = _swig_property(_scan.variant_start_pos_get,
                                   _scan.variant_start_pos_set)
    __swig_setmethods__["end_pos"] = _scan.variant_end_pos_set
    __swig_getmethods__["end_pos"] = _scan.variant_end_pos_get
    if _newclass:
        end_pos = _swig_property(_scan.variant_end_pos_get,
                                 _scan.variant_end_pos_set)
    ...
    if _newclass:
        modified_seq = _swig_property(_scan.variant_modified_seq_get,
                                      _scan.variant_modified_seq_set)
...
class match_with_variant(_object):
    ...
    __setattr__ = lambda self, name, value: _swig_setattr(self,
                                                          ...
                                                          name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, match_with_variant,
                                                   name)
    __repr__ = _swig_repr
    __swig_setmethods__["pos"] = _scan.match_with_variant_pos_set
    __swig_getmethods__["pos"] = _scan.match_with_variant_pos_get
    if _newclass:
        pos = _swig_property(_scan.match_with_variant_pos_get,
                             _scan.match_with_variant_pos_set)
    __swig_setmethods__["score"] = _scan.match_with_variant_score_set
    __swig_getmethods__["score"] = _scan.match_with_variant_score_get
    if _newclass:
        score = _swig_property(_scan.match_with_variant_score_get,
                               _scan.match_with_variant_score_set)
    ...
    if _newclass:
        variants = _swig_property(_scan.match_with_variant_variants_get,
                                  _scan.match_with_variant_variants_set)
...
class Scanner(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, Scanner, name,
                                                          value)
    __swig_getmethods__ = {}
